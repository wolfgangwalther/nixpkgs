    ...
    writeText "changed-paths.json" (
      builtins.toJSON {
        ...
        labels =
          ...
          // lib.mapAttrs' (kernel: rebuilds: lib.nameValuePair "10.rebuild-${kernel}-stdenv" (lib.elem "stdenv" rebuilds)) rebuildsByKernel
          ...
          // {
            "11.by: package-maintainer" = maintainers ? ${githubAuthorId}
